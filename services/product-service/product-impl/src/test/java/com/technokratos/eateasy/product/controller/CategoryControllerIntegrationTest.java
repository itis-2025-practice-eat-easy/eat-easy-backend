...
class CategoryControllerIntegrationTest {
    ...
    void createCategoryTest() {
        ...
        jdbcTemplate.query("SELECT * FROM category WHERE id = :id",
    ...
    void getAllCategoriesTest() {
        restTemplate.postForEntity("/api/v1/categories", new CategoryRequest(CATEGORY_NAME), CategoryResponse.class);
    ...
    void getProductsByCategoryEmptyTest() {
        UUID categoryId = restTemplate.postForEntity("/api/v1/categories",
                        new CategoryRequest(CATEGORY_NAME),
                        CategoryResponse.class)
                .getBody().id();
    ...
    void getProductsByCategoryWithFiltersTest() {
        ...
        String url = String.format("/api/v1/categories/%s/products?order_by=price&page=0&page_size=5", categoryId);
