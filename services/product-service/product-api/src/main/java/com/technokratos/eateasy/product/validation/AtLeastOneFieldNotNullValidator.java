...
public class AtLeastOneFieldNotNullValidator implements ConstraintValidator<AtLeastOneFieldNotNull, ProductUpdateRequest> {
    ...
    public boolean isValid(ProductUpdateRequest request, ConstraintValidatorContext context) {
        boolean valid = request.title() != null ||
