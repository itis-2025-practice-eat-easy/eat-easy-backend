package com.smesitejl.product.controller;

import com.smesitejl.product.api.ProductApi;
import com.smesitejl.product.entity.Product;
import com.smesitejl.product.service.ProductService;
...
public class ProductController implements ProductApi {
    ...
    @Override
    public ResponseEntity<Void> update(UUID productId, @Valid @RequestBody Product product) {
