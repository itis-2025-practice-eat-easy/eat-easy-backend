...
public class QueryProvider {
    ...
    private QueryProvider() {
        ...
        loadAllSqlQueries("db/query/product", sqlQueriesForProduct);
        loadAllSqlQueries("db/query/category", sqlQueriesForCategory);
    }

    public void loadAllSqlQueries(String directory, Map<String, String> sqlQueriesMap) {
        try {
            Path dirPath = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource(directory)).toURI());
